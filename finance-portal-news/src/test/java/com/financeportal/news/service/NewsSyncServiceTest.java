...
class NewsSyncServiceTest {
    ...
    void setUp() {
        ...
        service = new NewsSyncService(redisTemplate, rssClient, objectMapper, categoryClassifier, new NewsEntityTagger(), translationClient);
    ...
    void fetch_emptyCache_fetchesAllSourcesAndCaches() {
        ...
        assertTrue(service.hasCompletedSync(), "finally bloğuna ulaşılmalı");
    }
    ...
    @Test
    void fetch_hataOlsaBileTamamlandiIsaretlenir() {
