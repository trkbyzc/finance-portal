...
export default function NavActions() {
    ...
    return (
        <div className="flex items-center gap-4 shrink-0">
            <Link to="/markets/live" className="hidden min-[1750px]:flex items-center gap-2 bg-sell/10 text-sell px-2.5 py-1 rounded-md border border-sell/20 hover:bg-sell/20 transition-colors mr-1">
